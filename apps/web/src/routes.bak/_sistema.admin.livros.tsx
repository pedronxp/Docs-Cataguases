                            ...
                            <TableRow className="hover:bg-slate-50 transition-colors">
                                ...
                                <TableCell className="text-right">
                                    <div className="flex items-center justify-end gap-2">
                                        <Button variant="ghost" size="icon" className="text-slate-500 hover:text-[#1351B4]" title="Histórico de Emissões">
                                            <History className="h-4 w-4" />
                                        </Button>
                                        <Button variant="ghost" size="icon" className="text-slate-500 hover:text-[#1351B4]" title="Editar Máscara">
