                                            ...
                                            <TableCell className="text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    <Button
                                                        variant="outline"
                                                        size="sm"
                                                        className="text-slate-500 border-slate-200 hover:bg-slate-100 h-8 font-semibold"
                                                        onClick={() => toast({ title: 'Em Desenvolvimento', description: 'Rejeição de acesso será implementada na próxima fase.' })}
                                                    >
                                                        Recusar
                                                    </Button>
                                                    <Button
