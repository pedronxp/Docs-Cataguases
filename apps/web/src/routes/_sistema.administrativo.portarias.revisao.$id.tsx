...
function PortariaRevisaoPage() {
    ...
    useEffect(() => {
        ...
        const interval = setInterval(async () => {
            ...
            if (res.success && res.data.status === 'PENDENTE') {
                ...
                toast({ title: '✅ PDF gerado!', description: 'O documento está pronto para revisão.' })
    ...
    const handleSubmit = async () => {
        ...
        reader.onloadend = async () => {
            ...
            if (res.success) {
                toast({ title: 'Documento submetido!', description: 'O PDF está sendo gerado. Aguarde...' })
                        ...
                        <CardContent className="p-5 space-y-5">
                            ...
                            <div className="space-y-2">
                                ...
                                <Button
                                    ...
                                    onClick={() => {
                                        toast({ title: 'Simulando download...', description: 'Em produção, o arquivo real seria baixado do storage.' })
                                    }}
                                >
                        ...
                        <CardContent className="p-5 space-y-4">
                            {isProcessando ? (
                                <div className="flex flex-col items-center gap-3 py-4 text-center">
                                    ...
                                    <p className="text-xs text-blue-500 font-medium">Você será redirecionado automaticamente quando pronto.</p>
                                </div>
                            ) : (
                                <>
                                    ...
                                    <p className="text-[11px] text-slate-400 text-center font-medium leading-tight">
                                        Após submeter, um número oficial será alocado automaticamente e o PDF será gerado.
                                    </p>
                                </>
                            )}
                        </CardContent>
