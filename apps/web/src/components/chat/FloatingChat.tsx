...
const MODELS = [
    { value: '', provider: '', label: 'Automático recomendado', sub: 'Groq GPT-OSS 120B' },
    { value: 'openai/gpt-oss-120b', provider: 'groq', label: 'GPT-OSS 120B', sub: 'Melhor qualidade' },
    { value: 'openai/gpt-oss-20b', provider: 'groq', label: 'GPT-OSS 20B', sub: 'Mais rápido' },
]
